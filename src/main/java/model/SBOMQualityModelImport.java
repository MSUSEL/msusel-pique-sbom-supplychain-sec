...
/**
 * COPIED ALL CODE WITH SMALL CHANGE TO USE THE SBOM DIAGNOSTIC NODE
 *
 ...
 *</p>
 */
public class SBOMQualityModelImport {
     ...
     */
    public SBOMQualityModelImport(Path qmFileLocation) {
        try {
    ...
    public QualityModel importQualityModel() {
        ...
        diagnostics = instanceSBOMDiagnosticsFromJson(jsonDiagnostics);
    ...
    private Map<String, ModelNode> instanceSBOMDiagnosticsFromJson(JsonObject diagnosticsJson) {
    ...
    // unfortunately I cannot access the private methods in QualityModelImport so I have to copy them here
